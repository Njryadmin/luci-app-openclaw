...
# 写入文件
{
  ...
  echo '```'
  echo ''
  echo '[使用文档](https://github.com/Njryadmin/luci-app-openclaw#readme) · [问题反馈](https://github.com/Njryadmin/luci-app-openclaw/issues) · [B站](https://space.bilibili.com/59438380) · [博客](https://blog.910501.xyz/)'
} > "${OUT_DIR}/${VER}.md"
