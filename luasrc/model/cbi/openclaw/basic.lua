...
act.cfgvalue = function(self, section)
	...
	html[#html+1] = 'window._ocInitialBackupPath = ' .. luci.json.encode(initial_backup_dir) .. ';'
	html[#html+1] = 'window._ocDefaultBackupPath = ' .. luci.json.encode(default_backup_dir) .. ';'
	html[#html+1] = '</script>'
...
guide.cfgvalue = function()
	...
	html[#html+1] = '<a href="https://github.com/Njryadmin/luci-app-openclaw" target="_blank" rel="noopener" style="color:#24292f;font-weight:bold;text-decoration:none;">'
	html[#html+1] = '🐙 Njryadmin/luci-app-openclaw</a></div></div>'
	return table.concat(html, "\n")
end
